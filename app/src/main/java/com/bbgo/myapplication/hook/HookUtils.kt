...
class HookUtils {
    companion object {
        ...
        private const val PROXY_ACTIVITY_PKG = "com.bbgo.myapplication"
        private const val PROXY_ACTIVITY = "com.bbgo.myapplication.hook.ProxyActivity"
            ...
            try {
                ...
                val proxyInstance = Proxy.newProxyInstance(
                    ...
                    if (method.name == "startActivity") {
                        ...
                        proxyIntent.setClassName(PROXY_ACTIVITY_PKG, PROXY_ACTIVITY)
